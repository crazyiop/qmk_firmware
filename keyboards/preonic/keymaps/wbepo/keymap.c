...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BEPO] = {
    ...
    {COPY,     PASTE,   CUT,     MO(LOWER), KC_LALT, KC_BSPC,        KC_SPC,      KC_RALT, MO(RAISE), xxxxxxx, xxxxxxx, BP_CCED},
  },

  [RAISE] = {
    {_______, _______, BP_LESS, BP_GRTR, _______, _______, _______, BP_PSMS, BP_MMNS, BP_OBEL, BP_DVSN, BP_DIFF},
    {_______, BP_PIPE, BP_LBRC, BP_RBRC, _______, BP_DGRV, _______, _______, _______, _______, _______, _______},
  ...
  [LOWER] = {
    {_______, _______, _______, _______, _______, _______, _______, _______,    _______, _______,    _______, _______},
    {_______, _______, BP_DACT, _______, BP_OE,   _______, _______, RCTL(BP_B), KC_UP,   RCTL(BP_W), _______, _______},
