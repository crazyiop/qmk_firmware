...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [RAISE] = {
    ...
    {_______, _______, _______, _______, BP_UNDS, _______, _______, _______, _______, _______, _______, _______},
  },
  ...
  [LOWER] = {
    ...
    {_______, _______, _______, _______, _______, _______, _______, _______,    _______, _______,    _______, _______},
    {_______, _______, _______, _______, _______, _______, _______, BP_UNDS,    _______, _______,    _______, _______},
  },
